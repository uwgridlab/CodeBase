...
if any(EDF.ErrNo==1025)
        fprintf(EDF.FILE.stderr,'Warning %s: Header 1 contains ASCII(0) - should be spaces\n',upper(EDF.AS.Method)); 
        EDF.ErrNo(EDF.ErrNo==1025)=[];
end;
if any(EDF.ErrNo==1026)
        fprintf(EDF.FILE.stderr,'Warning %s: Header 2 contains ASCII(0) - should be spaces\n',upper(EDF.AS.Method)); 
