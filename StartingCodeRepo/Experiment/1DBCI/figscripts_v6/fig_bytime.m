...
clearvars -except allresults alltargets allwindows allepochs bads Montage subjid side pre post fs div num id theme_colors red blue green big small cacheOutDir figOutDir;
