...
clearvars -except allresults alltargets allwindows allepochs bads Montage subjid side pre post fs div id theme_colors red blue green big small;
...
%     mtit(tit, 'xoff', 0, 'yoff', .1, 'FontSize', big, 'FontName',
%     'Arial');
