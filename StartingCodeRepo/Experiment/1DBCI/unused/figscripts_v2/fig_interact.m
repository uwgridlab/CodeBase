...
%     %     sigScored = exp(sigScored);
        ...
        windows = getEpochSignal(signals, epochs(fbepochs,2)-pre*fs, epochs(fbepochs,2)+post*fs);
    ...
    save(cachefile, 'allresults', 'alltargets', 'allwindows', 'allepochs', 'bads', 'Montage', 'subjid', 'side', 'pre', 'post', 'fs');
end
