...
%%
load('d:\research\code\gridlab\Experiment\1DBCI\figscripts\cache\fig_bytime.30052b.mat')
...
figure, plot(t, mean(upwin,2),'Color', theme_colors(red,:), 'LineStyle', ':'); hold on;
