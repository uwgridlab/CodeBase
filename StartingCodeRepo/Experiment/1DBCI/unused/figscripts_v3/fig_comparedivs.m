%% analysis for comparing the distribution of division points for all
%% electrodes (showing a change?) with that of the control electrode.
%% uses the same methodology as fig_finddivs.m
...
%         SaveFig(fullfile(pwd, 'figs'), 'find_div_ex', 'eps');
    end
end
