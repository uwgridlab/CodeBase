...
% fc9643 - S1
Montage.MontageTokenized = {'Grid(56)','Grid(20)','Grid(7)'};
locs = trodeLocsFromMontage('fc9643', Montage, true);

% 30052b - S5
Montage.MontageTokenized = {'Grid(52)'};
locs = cat(1, locs, trodeLocsFromMontage('30052b', Montage, true));

% % 4568f4 - S4
Montage.MontageTokenized = {'Grid(47)', 'Grid(32)', 'Grid(16)'};
...
cats = [PMd PFC PMv PFC M1 PMv M1 PMv];
