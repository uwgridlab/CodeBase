...
elseif (strcmp(sid, '702d24'))    
    tank = TTank;
    tank.openTank('d:\research\subjects\702d24\data\d7\702d24_BetaStim');
...
dat = squeeze(getEpochSignal(beta', stims(2, cts)-preSamp, stims(2, cts)+postSamp+1));
rdat = squeeze(getEpochSignal(raw', stims(2, cts)-preSamp, stims(2, cts)+postSamp+1));
