...
% %                 fullfile(myGetenv('subject_dir'), 'c91479\data\d5\c91479_goal_bci_session2001\c91479_goal_bci_session2S001R03.dat'), ...
        ...
        case '979eab'
            % This subject served as a visual control for the others. All
            % we did was present the targets and the cursor (with no motion
            % during the feedback period to see if/where there is
            % representation of the target position without task salience.
            ...
            files = {                
                fullfile(myGetenv('subject_dir'), '979eab\data\d4\979eab_goal_bci_screen001\979eab_goal_bci_screenS001R03.dat'), ...
                };
