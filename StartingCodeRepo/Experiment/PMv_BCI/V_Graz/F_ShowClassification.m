...
load(fullfile(META_DIR, 'graz', 'areas.mat'));
...
for idx = 1:length(SIDS)
    ...
    load(fullfile(META_DIR, 'graz', sprintf('%s_results.mat', sid)), 'class');
...
maximize;
SaveFig(fullfile(OUTPUT_DIR, 'graz'), 'trode_choice_r', 'png', '-r600');
