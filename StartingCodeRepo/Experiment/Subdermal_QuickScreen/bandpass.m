...
function filteredSignals = bandpass(signals, hpFreq, lpFreq, fSamp, filterOrder, causality)
    ...
    filteredSignals = ecogFilter(signals, false, 0, true, hpFreq, true, lpFreq, fSamp, filterOrder, causality);
end