function [trf, tef, trl, tel, order] = lassoGoalFeatureSelection(data, labels, istest, ignore)
    ...
    [B, info] = lasso(nfeatures(keptFeatures, ~istest)', labels(~istest)', 'Standardize');
