...
function filteredSignals = notch(signals, lnFreqs, fSamp, filterOrder, causality)
    ...
    filteredSignals = ecogFilter(signals, true, lnFreqs, false, 0, false, 0, fSamp, filterOrder, causality);
